...
public class Product implements Serializable {
    ...
    public Product calificacions(Set<Calificacion> calificacions) {
        this.calificacions = calificacions;
        return this;
    }

    public Product addCalificacion(Calificacion calificacion) {
        this.calificacions.add(calificacion);
        calificacion.setProduct(this);
        return this;
    }

    public Product removeCalificacion(Calificacion calificacion) {
        this.calificacions.remove(calificacion);
        calificacion.setProduct(null);
        return this;
    }
